...
function createPhoneMask(selector){  attachMaskToSelector(phoneMask, selector); }

//custom mask functions
var moneyMask = new Mask("####.000", "number");
function createMoneyMask(selector){  attachMaskToSelector(moneyMask, selector); }

function attachMaskToSelector(mask, selector){
