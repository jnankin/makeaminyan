...
class MobileDetector {
    ...
    protected $devices = array(
        ...
        "iphone"        => "(iphone|ipod)",
        "opera"         => "opera mini",
        "palm"          => "(webos|avantgo|blazer|elaine|hiptop|palm|plucker|xiino)",
        "windows"       => "windows ce; (iemobile|ppc|smartphone)",
        "generic"       => "(kindle|mobile|mmp|midp|o2|pda|pocket|psp|symbian|smartphone|treo|up.browser|up.link|vodafone|wap|LGE|lg-)"
    );
